            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
              <ul class="timeline">
                ...
                <li>
                  <div class="tl-circ"></div>
                  <div class="timeline-panel">
                    <img src="img/art-gallery.jpg" class="img-responsive home-img">
                    <button class="btn btn-default buynow-btn">BUY NOW</button>
                    <h3>John Doe
                      <span>
                        <img src="{{asset('img/user2-160x160.jpg')}}" class="img-circle pull-right img-responsive" alt="User Image">
            ...
            <div class="collapse navbar-collapse padding0" id="rightNavbar">
              <div class="well sidebar-nav follower-sidebar" data-spy="affix" data-offset-top="110">
                <ul class="nav nav-list">
                  ...
                  <li><a href="#"><img src="{{asset('img/user2.jpg')}}" class="img-circle" width="30">&emsp;<span class="follower-text">John Doe</span></a></li>
                  <li><a href="#"><img src="{{asset('img/user2.jpg')}}" class="img-circle" width="30">&emsp;<span class="follower-text">Mark Spencer</span></a></li>
                </ul>
              </div>
            </div>
